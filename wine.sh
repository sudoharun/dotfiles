...
cd ~
yay -S --noconfirm wine-staging winetricks dxvk-bin lib32-gnutls lib32-libxcomposite lib32-mesa lib32-vkd3d lib32-libva lib32-vulkan-icd-loader lib32-vulkan-intel lib32-vulkan-mesa-layers samba
