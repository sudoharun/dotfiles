...
cd ~
yay -S hyprland qt5-wayland qt6-wayland linux-headers alacritty zsh neovim firefox-developer-edition udisks2 unrar unzip ttf-jetbrains-mono-nerd ttf-iosevka-nerd ttf-iosevkaterm-nerd sof-firmware wofi wofi-emoji dunst polkit-gnome ranger reflector-simple playerctl pavucontrol pamixer p7zip noto-fonts noto-fonts-cjk noto-fonts-emoji-apple neofetch mpv iw htop gimp dragon-drop deluge-gtk vencord-desktop-git ccache brillo alsa-firmware alsa-ucm-conf bluez capitaine-cursors zip upower ttf-roboto filezilla xdg-desktop-portal xdg-desktop-portal-gtk xdg-desktop-portal-hyprland-git papirus-icon-theme swaylock-effects-git wireless_tools wev nwg-look-bin openshot imv hyprpaper grim slurp dosfstools socat bc sysstat btop ueberzugpp swww waypaper-git
